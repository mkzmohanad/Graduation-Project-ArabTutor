...
function UpdateUserData() {
    ...
    function handleSubmitUpdateUserData(data) {
        ...
        // console.log();
        setUpdatedDataHolder(Object.fromEntries(formData.entries()))
    ...
    if(isUpdating || isLoadingUser || isUpdatingPassword) return <Loading />
        ...
        <div className=" pt-32 px-3 sm:px-12 lg:px-32 pb-12 bg-darkestColor space-y-12 w-full">
            <div className="bg-darkColor p-5 sm:p-10 flex flex-col items-center gap-10 rounded-3xl">
                ...
                <div className="flex items-center justify-center xl:justify-end gap-6 w-full xl:w-1/2">
                    <Button type = "operations" disabled={isUpdatingPassword || isUpdating}>{isUpdating ? <MiniSpinner /> : "Update Data"}</Button>
                </div>
                </form>
            </div>
            ...
            <div className="bg-darkColor p-5 sm:p-10 flex flex-col items-center gap-10 rounded-3xl">
                ...
                <div className="flex items-center justify-center xl:justify-end gap-6 w-full xl:w-1/2">
                    <Button type = "operations" disabled={isUpdatingPassword || isUpdating}>{isUpdatingPassword ? <MiniSpinner /> : "Update password"}</Button> 
                </div>
                </form>
            </div>
        </div>
