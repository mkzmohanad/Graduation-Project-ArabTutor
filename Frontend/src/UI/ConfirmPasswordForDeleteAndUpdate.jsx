...
function ConfirmPasswordForDeleteAndUpdate({type , handleSetToggleModal , updatedData}) {
    ...
    return  <div className="w-full sm:w-5/6 lg:w-2/3 h-1/2 relative">
        ...
        <form onSubmit={handleSubmit(handleSubmitConfirmPasswordForDeleteAndUpdate)} className=" flex flex-col justify-center gap-5 bg-mainBlue pt-16 pb-8 px-4 sm:px-10 z-30 rounded-lg">
            ...
            <div className="flex items-center w-full justify-center">
                <Button type = "danger" disabled={isDeleting || isLoggingOut || errors?.password}>
